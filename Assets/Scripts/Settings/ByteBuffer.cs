...
public class ByteBuffer
{
    ...
    public ByteBuffer AddSpan(ReadOnlySpan<byte> span)
    {
    ...
    public unsafe ByteBuffer AddSpan<T>(ReadOnlySpan<T> span) where T : unmanaged
    {
        Write((ushort)span.Length);
    ...
    public T GetStruct<T>() where T : IBufferStruct
    {
    ...
    public unsafe ByteBuffer Write<T>(T value) where T : unmanaged
    {
        int size = sizeof(T);
    ...
    public unsafe ByteBuffer Write<T>(T[] value, ArrayLength length = ArrayLength.Short) where T : unmanaged
    {
        int size = sizeof(T);
